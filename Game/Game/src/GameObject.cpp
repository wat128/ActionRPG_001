...
GameObject::GameObject(const int32& value, const Vec2& pos)
	...
	, _direction(Direction::Down)
	, _collisionSize(ObjData::getInstance().collisionSize(value))
	, _collisionMargin(ObjData::getInstance().collisionMargin(value))
	, _collisionForMoveSize(ObjData::getInstance().collisionForMoveSize(value))
	, _collisionForMoveMargin(ObjData::getInstance().collisionForMoveMargin(value))
	, _ability(value)
	, _HurtTime(0)
{ }
